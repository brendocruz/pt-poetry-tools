...
class TestWordsWithHiatus(TestCase):
    ...
    def test_hiatus_i_with_accent(self):
    ...
    def test_hiatus_u_with_accent(self):
        splitter = WordSplitter()
    ...
    def test_hiatus_end_stressed_no_accent(self):
        splitter = WordSplitter()
    ...
    def test_hiatus_middle_stressed_no_accent(self):
        splitter = WordSplitter()
    ...
    def test_hiatus_always_end(self):
        splitter = WordSplitter()
